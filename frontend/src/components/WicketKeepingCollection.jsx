...
import { wicketKeepingBrands, wicketKeepingGloves, getWicketKeepingByBrand } from '../data/wicketKeepingData';
...
const WicketKeepingCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getWicketKeepingByBrand(selectedBrand);
  ...
  const inStockCount = wicketKeepingGloves.filter(p => p.inStock).length;
  const outOfStockCount = wicketKeepingGloves.filter(p => !p.inStock).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          src="https://crickstore.com/cdn/shop/files/3J13191.webp?v=1724856252&width=1946"
          alt="Wicket Keeping Gloves Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Premium wicket keeping gloves from top brands for professional keepers
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-wrap gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    All ({wicketKeepingGloves.length})
                  </button>
                  <button
...
export default WicketKeepingCollection;
