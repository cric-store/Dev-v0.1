...
const BattingGearCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getBattingGearByBrand(selectedBrand);
  ...
  const inStockCount = battingGear.filter(p => p.inStock).length;
  const outOfStockCount = battingGear.filter(p => !p.inStock).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          src="https://crickstore.com/cdn/shop/collections/IMG-20230421-WA0027.jpg?v=1725036976&width=1599"
          alt="Batting Gear Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Premium batting gloves and protective gear from top cricket brands
            </p>
          </div>
        </div>
      </div>
...
export default BattingGearCollection;
