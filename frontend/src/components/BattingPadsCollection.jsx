...
import { ChevronLeft, ChevronRight, X, ZoomIn, Heart, ShoppingCart, Check, Package, Truck, Shield, Filter, ChevronDown, Star } from 'lucide-react';
import { battingPadsBrands, battingPads, getBattingPadsByBrand } from '../data/battingPadsData';
...
const BattingPadsCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getBattingPadsByBrand(selectedBrand);
  ...
  const inStockCount = battingPads.filter(p => p.inStock).length;
  const outOfStockCount = battingPads.filter(p => !p.inStock).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          src="https://crickstore.com/cdn/shop/collections/test-blue-4-scaled.webp?v=1724999281&width=1946"
          alt="Batting Pads Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Cricket Batting Pads from top brands for maximum protection
            </p>
          </div>
        </div>
      </div>
...
export default BattingPadsCollection;
