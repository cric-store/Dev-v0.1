...
import { helmetBrands, cricketHelmets, getHelmetsByBrand } from '../data/cricketHelmetsData';
...
const CricketHelmetsCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getHelmetsByBrand(selectedBrand);
  ...
  const inStockCount = cricketHelmets.filter(p => p.inStock).length;
  const outOfStockCount = cricketHelmets.filter(p => !p.inStock).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          src="https://crickstore.com/cdn/shop/collections/SHREY_KOROYD_STAINLESS_STEEL_HK842_NAVY_2_HD_nUB_nbR3dd.webp?v=1724999918&width=1599"
          alt="Cricket Helmets Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Premium cricket helmets for maximum protection on the field
            </p>
          </div>
        </div>
      </div>
...
export default CricketHelmetsCollection;
