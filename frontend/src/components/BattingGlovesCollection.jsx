...
import { battingGlovesBrands, battingGloves, getBattingGlovesByBrand } from '../data/battingGlovesData';
          ...
          <div className="space-y-5">
            <div>
              ...
              <span className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-semibold ${
                product.brand === 'Spikes' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'
              }`}>
                {product.brand}
              </span>
            </div>
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
          ...
          <span className={`px-2 py-1 text-xs font-bold rounded-full shadow ${
            product.brand === 'Spikes' ? 'bg-orange-500 text-white' : 'bg-blue-500 text-white'
          }`}>
            {product.brand}
          </span>
        </div>
...
const BattingGlovesCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getBattingGlovesByBrand(selectedBrand);
  ...
  const inStockCount = battingGloves.filter(p => p.inStock).length;
  const outOfStockCount = battingGloves.filter(p => !p.inStock).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          src="https://crickstore.com/cdn/shop/collections/WhatsApp_Image_2024-08-27_at_11.57.13.jpg?v=1724740113&width=1946"
          alt="Cricket Batting Gloves Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Premium batting gloves from top brands for professional cricketers
            </p>
          </div>
        </div>
      </div>
...
export default BattingGlovesCollection;
