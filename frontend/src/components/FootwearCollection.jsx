          ...
          <div className="space-y-5">
            <div>
              ...
              <span className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-semibold ${
                product.type === 'Spikes' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'
              }`}>
                {product.type}
              </span>
            </div>
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
          ...
          <span className={`px-2 py-1 text-xs font-bold rounded-full shadow ${
            product.type === 'Spikes' ? 'bg-orange-500 text-white' : 'bg-blue-500 text-white'
          }`}>
            {product.type}
          </span>
        </div>
...
const FootwearCollection = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = getFootwearByBrand(selectedBrand);
  ...
  const inStockCount = footwearProducts.filter(p => p.inStock).length;
  const outOfStockCount = footwearProducts.filter(p => !p.inStock).length;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] md:h-[350px] overflow-hidden">
        <img
          ...
          alt="Cricket Footwear Collection"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            <p className="text-gray-300 text-lg max-w-xl">
              Cricket spikes and rubber studs from Puma, Asics, New Balance, DSC and more
            </p>
          </div>
        </div>
      </div>
